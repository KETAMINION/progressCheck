...
import { getDataModelsByEmail, updateDataModels, editButtonModels,deleteButtonModels } from "../models/index.js"
...
router.delete("/:id", async function(req,res) {
    const result = await deleteButtonModels(req.params.id)
    return res.json({success: true, payload: result}) 
})
